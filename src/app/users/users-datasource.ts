...
export class UsersDataSource extends DataSource<UsersItem> {
  ...
  data: UsersItem[] = this.getUsers();

  constructor(private paginator: MatPaginator, private sort: MatSort, private usersService: UsersService) {
    super();
  }

  getUsers(): UsersItem[] {

    var teste = this.usersService.getUsers()
    console.log(teste)
  ...
  private getSortedData(data: UsersItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'name': return compare(a.id, b.login, isAsc);
